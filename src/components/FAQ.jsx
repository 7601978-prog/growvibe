...
const faqs = [
  ...
  { q: 'Что я возьму с собой после занятия?', a: 'Готовый цифровой проект (сайт, лендинг или прототип), базовые промпты и понимание, как продолжать работу самостоятельно.' },
  { q: 'Можно ли вернуть деньги?', a: 'Да, если предупредить за 48 часов до занятия. После — место передаётся другому участнику.' },
  { q: 'Нужен ли опыт работы с AI?', a: 'Нет, всё объясняем с нуля. Подготовительный флоу поможет настроить инструменты заранее.' },
]
