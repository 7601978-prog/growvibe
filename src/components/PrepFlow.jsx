          ...
          {step.tokenField && (
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                Вставь GitHub токен здесь (сохранится только в браузере):
              </label>
              <input
                type="password"
                value={token}
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:border-[#D97757] focus:ring-1 focus:ring-[#D97757]/30"
              />
            </div>
          )}
    ...
    >
      <div className="max-w-3xl mx-auto px-6">
        ...
        <p className="text-gray-500 text-lg mb-6">
          Мы хотим, чтобы на обучение пришли подготовленные участники. Пройди флоу заранее — это займёт 40–60 минут.
        </p>
